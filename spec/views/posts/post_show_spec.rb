...
RSpec.describe 'posts/show.html.erb', type: :feature do
  before :each do
    @user = User.create(name: 'Tonny', photo: 'https://unsplash.com/photos/-xa9XSA7K9k', bio: 'Programmer',
                        posts_counter: 0)
    @user2 = User.create(name: 'Tei', photo: 'https://unsplash.com/photos/-xa9XSA7K9k', bio: 'Programmer',
                         posts_counter: 0)
    @user3 = User.create(name: 'Ajema', photo: 'https://unsplash.com/photos/-xa9XSA7K9k', bio: 'Programmer',
                         posts_counter: 0)
